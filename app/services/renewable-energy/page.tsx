      ...
      <main className="min-h-screen bg-blue-50 dark:bg-blue-950 text-blue-950 dark:text-white pb-2">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* Row 1 */}
            <img src="/images/grid battery.jpg" alt="Solar Panel Array" className="object-cover w-full h-full rounded-xl" />
            ...
            <img src="/images/solar.jpg" alt="Large Scale Solar Farm" className="object-cover w-full h-full rounded-xl" />
            ...
            <img src="/images/whatsApp Image 2025-06-04 at 15.33.21 (1).jpeg" alt="Battery Storage" className="object-cover w-full h-full rounded-xl" />
            <div className="bg-white dark:bg-blue-900 text-blue-950 dark:text-white p-8 rounded-xl flex flex-col justify-center items-center text-center shadow-md">
            ...
            {/* Row 3 */}
            <img src="/images/show1.jpeg" alt="Solar Carport Structure" className="object-cover w-full h-full rounded-xl" />
            <div className="bg-white dark:bg-blue-900 text-blue-950 dark:text-white p-8 rounded-xl flex flex-col justify-center items-center text-center shadow-md">
            ...
            <img src="/images/container.jpg" alt="Containerised Energy Unit" className="object-cover w-full h-full rounded-xl" />
            ...
            <img src="/images/ground.jpg" alt="Energy Infrastructure Installation" className="object-cover w-full h-full rounded-xl" />
            <div className="bg-white dark:bg-blue-900 text-blue-950 dark:text-white p-8 rounded-xl flex flex-col justify-center items-center text-center shadow-md">
