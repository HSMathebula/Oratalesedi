      ...
      <main className="min-h-screen bg-blue-50 dark:bg-blue-950 text-blue-950 dark:text-white pb-2">
        ...
        <div className="relative w-full h-[400px] flex items-center justify-center mb-8">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center w-full h-full">
            <h1 className="text-5xl font-black text-center mt-10 drop-shadow-lg text-white dark:text-white">Construction</h1>
          </div>
        </div>
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* Row 1 */}
            <img src="/images/whatsApp Image 2025-06-04 at 14.53.22.jpeg" alt="Modular Construction" className="object-cover w-full h-64 rounded-xl" />
            ...
            <img src="/images/whatsApp Image 2025-06-04 at 15.18.13.jpeg" alt="Construction Work" className="object-cover w-full h-64 rounded-xl" />
